		...
		// TODO Auto-generated constructor stub
			...
			public String toString() {
				return "CreditCardBean [creditCardNumber=" + creditCardNumber + ", creditCardStatus=" + creditCardStatus
						+ ", nameOnCreditCard=" + nameOnCreditCard + ", CreditCvvNum=" + CreditCvvNum
						+ ", creditCurrentPin=" + creditCurrentPin + ", creditDateOfExpiry=" + creditDateOfExpiry
						+ ", UCI=" + UCI + ", creditCardType=" + creditCardType + ", creditScore=" + creditScore
						+ ", creditLimit=" + creditLimit + ", incomeTaxReturn=" + incomeTaxReturn + "]";
			}
